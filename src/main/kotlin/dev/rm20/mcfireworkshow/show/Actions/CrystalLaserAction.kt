...
class CrystalLaserAction {
    companion object {
        val activeLasers = mutableMapOf<String, Laser>()
    }

    fun handleLaserAction(laserData: ActionData.CrystalLaserData, lasers: List<LaserPoint>) {
        ...
        for (point in laserPoints) {
            ...
            if (existingLaser != null) {
                ...
                try {
                    val newLaser = Laser.CrystalLaser(startLocation, endLocation, -1, laserData.distance)
